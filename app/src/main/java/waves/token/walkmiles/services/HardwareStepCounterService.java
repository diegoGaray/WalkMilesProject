...
import waves.token.walkmiles.persistence.StepCountDbHelper;
import waves.token.walkmiles.persistence.WalkingModeDbHelper;
import waves.token.walkmiles.utils.AndroidVersionHelper;

import java.util.Calendar;

import static waves.token.walkmiles.persistence.StepCountPersistenceHelper.BROADCAST_ACTION_STEPS_SAVED;
