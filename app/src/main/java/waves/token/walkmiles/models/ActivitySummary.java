...
public class ActivitySummary {
    ...
    public ActivitySummary(int steps, double distance, int walkMiles) {
        this(steps, distance, walkMiles, "");
    }

    public ActivitySummary(int steps, double distance, double walkMiles, String title) {
        this.steps = steps;
