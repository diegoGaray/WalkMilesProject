...
public class LoginActivity extends AppCompatActivity {
    ...
    @BindView(waves.token.walkmiles.R.id.btn_login) Button _loginButton;
    @BindView(waves.token.walkmiles.R.id.link_signup) TextView _signupLink;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(waves.token.walkmiles.R.layout.activity_login);
