...
*/
package waves.token.walkmiles.receivers;
...
import waves.token.walkmiles.activities.SplashActivity;
...
public class WidgetReceiver extends AppWidgetProvider {
    public static final String PAUSE_STEP_DETECTION_ACTION = "waves.token.walkmiles.PAUSE_STEP_DETECTION_ACTION";
    public static final String CONTINUE_STEP_DETECTION_ACTION = "waves.token.walkmiles.CONTINUE_STEP_DETECTION_ACTION";
