...
*/
package com.mileston.walk.walkmilestonandroid.fragments;
...
import com.mileston.walk.walkmilestonandroid.adapters.ReportAdapter;
...
import com.mileston.walk.walkmilestonandroid.models.StepCount;
...
import com.mileston.walk.designwalk.header.MaterialViewPagerHeaderDecorator;
            ...
            public void run() {
                ...
                for (int i = 0; i <= day.getActualMaximum(Calendar.DAY_OF_MONTH); i++) {
                    ...
                    for (StepCount stepCount : stepCounts) {
                        ...
                        calories += stepCount.getStepCount();
                    }
                    ...
                    totalCalories += calories*0.0005;
                    totalCalories = truncate(totalCalories);
                ...
                if (activitySummary == null) {
                    ...
                    activitySummary.setwalkMiles(totalCalories);
