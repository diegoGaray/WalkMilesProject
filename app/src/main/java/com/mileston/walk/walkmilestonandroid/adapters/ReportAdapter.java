...
import com.mileston.walk.walkmilestonandroid.models.ActivityChart;
import com.mileston.walk.walkmilestonandroid.models.ActivityChartDataSet;
import com.mileston.walk.walkmilestonandroid.models.ActivityDayChart;
import com.mileston.walk.walkmilestonandroid.models.ActivitySummary;
...
public class ReportAdapter extends RecyclerView.Adapter<ReportAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        switch (getItemViewType(position)) {
            case TYPE_CHART:
                ...
                barChartViewHolder.mTitleTextView.setText(barChartData.getTitle().replace(".", ""));
                int barChartI = 0;
            ...
            case TYPE_DAY_CHART:
                ...
                chartViewHolder.mTitleTextView.setText(chartData.getTitle().replace(".", ""));
                ...
                if (chartData.getDisplayedDataType() == null) {
                    ...
                    switch (chartData.getDisplayedDataType()) {
                        case DISTANCE:
                            ...
                            break;
                        case WALKMILES:
                            dataMap = chartData.getwalkMiles();
                        ...
                        default:
                            dataMap = chartData.getSteps();
                            label = chartViewHolder.context.getString(R.string.steps);
                            legendValues.put(ContextCompat.getColor(chartViewHolder.itemView.getContext(), R.color.colorAccent), " ");
                            break;
                    }
                }
            ...
            case TYPE_SUMMARY:
                ...
                UnitHelper.FormattedUnitPair calories = UnitHelper.formatCalories(summaryData.getwalkMiles(), summaryViewHolder.itemView.getContext());
                summaryViewHolder.mTitleTextView.setText((summaryData.getTitle()).replace(".", ""));
                ...
                summaryViewHolder.mCaloriesTextView.setText("");
                if (summaryData.getSteps()==0){
                    summaryViewHolder.mCaloriesTitleTextView.setText(String.valueOf(0.0000));
                }else{
                    summaryViewHolder.mCaloriesTitleTextView.setText(String.valueOf(summaryData.getwalkMiles()));
                }
               // summaryViewHolder.mCaloriesTitleTextView.setText(String.valueOf(summaryData.getwalkMiles()));
    ...
    public abstract class AbstractChartViewHolder extends ViewHolder{
