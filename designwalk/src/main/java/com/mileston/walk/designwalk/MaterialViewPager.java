package com.mileston.walk.designwalk;
...
import com.mileston.walk.designwalk.header.HeaderDesign;
...
public class MaterialViewPager extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        com.mileston.walk.designwalk.MaterialViewPagerAnimator animator = com.mileston.walk.designwalk.MaterialViewPagerHelper.getAnimator(this.getContext());

        //-1*ss.yOffset restore to 0
        animator.restoreScroll(-1 * ss.yOffset, ss.settings);
        com.mileston.walk.designwalk.MaterialViewPagerHelper.register(getContext(), animator);
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        ss.yOffset = com.mileston.walk.designwalk.MaterialViewPagerHelper.getAnimator(getContext()).lastYOffset;
    ...
    public PagerSlidingTabStrip getPagerTitleStrip() {
        return (PagerSlidingTabStrip) pagerTitleStripContainer.findViewById(com.mileston.walk.designwalk.R.id.materialviewpager_pagerTitleStrip);
    }
    ...
    public void setImageUrl(String imageUrl, int fadeDuration) {
        if (imageUrl != null) {
            final ImageView headerBackgroundImage = (ImageView) findViewById(com.mileston.walk.designwalk.R.id.materialviewpager_imageHeader);
    ...
    public void setImageHeaderDarkLayerAlpha() {
        final View headerImageDarkLayerView = findViewById(com.mileston.walk.designwalk.R.id.materialviewpager_headerImageDarkLayer);
        //if using MaterialViewPagerImageHeader
    ...
    public void setColor(int color, int fadeDuration) {
        if (com.mileston.walk.designwalk.MaterialViewPagerHelper.getAnimator(getContext()) != null) {
            com.mileston.walk.designwalk.MaterialViewPagerHelper.getAnimator(getContext()).setColor(color, fadeDuration * 2);
        }
    }
    ...
    public void onPageScrollStateChanged(int state) {
        ...
        if (settings.displayToolbarWhenSwipe) {
            com.mileston.walk.designwalk.MaterialViewPagerHelper.getAnimator(getContext()).onViewPagerPageChanged();
        }
    }
    ...
    protected void onDetachedFromWindow() {
        com.mileston.walk.designwalk.MaterialViewPagerHelper.unregister(getContext());
        listener = null;
    ...
    protected void onFinishInflate() {
        ...
        addView(LayoutInflater.from(getContext()).inflate(com.mileston.walk.designwalk.R.layout.material_view_pager_layout, this, false));

        headerBackgroundContainer = (ViewGroup) findViewById(com.mileston.walk.designwalk.R.id.headerBackgroundContainer);
        pagerTitleStripContainer = (ViewGroup) findViewById(com.mileston.walk.designwalk.R.id.pagerTitleStripContainer);
        viewpagerContainer = (ViewGroup) findViewById(com.mileston.walk.designwalk.R.id.viewpager_layout);
        logoContainer = (ViewGroup) findViewById(com.mileston.walk.designwalk.R.id.logoContainer);

        mToolbar = (Toolbar) findViewById(com.mileston.walk.designwalk.R.id.toolbar);
        ...
        mViewPager = (ViewPager) findViewById(com.mileston.walk.designwalk.R.id.materialviewpager_viewpager);
...

        {
            ...
            if (headerId == -1) {
                if (settings.animatedHeaderImage) {
                    headerId = com.mileston.walk.designwalk.R.layout.material_view_pager_moving_header;
                } else {
                    headerId = com.mileston.walk.designwalk.R.layout.material_view_pager_imageview_header;
                }
            }
        ...
        if (isInEditMode()) { //preview titlestrip
            ...
            settings.pagerTitleStripId = com.mileston.walk.designwalk.R.layout.tools_material_view_pager_pagertitlestrip;
        }
        ...
        headerBackground = findViewById(com.mileston.walk.designwalk.R.id.headerBackground);
        toolbarLayoutBackground = findViewById(com.mileston.walk.designwalk.R.id.toolbar_layout_background);
        ...
        if (!isInEditMode()) {
            materialViewPagerHeader = MaterialViewPagerHeader
                    ...
                    .withStatusBackground(findViewById(com.mileston.walk.designwalk.R.id.statusBackground))
            ...
            View sample = LayoutInflater.from(getContext()).inflate(com.mileston.walk.designwalk.R.layout.tools_list_items, pagerTitleStripContainer, false);

            FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) sample.getLayoutParams();
            int marginTop = Math.round(com.mileston.walk.designwalk.Utils.dpToPx(settings.headerHeight + 10, getContext()));
    ...
    private void initialiseHeights() {
        if (headerBackground != null) {
            ...
            layoutParams.height = (int) com.mileston.walk.designwalk.Utils.dpToPx(this.settings.headerHeight + settings.headerAdditionalHeight, getContext());
        ...
        if (pagerTitleStripContainer != null) {
            ...
            int marginTop = (int) com.mileston.walk.designwalk.Utils.dpToPx(this.settings.headerHeight - 40, getContext());
    ...
    static class SavedState extends BaseSavedState {
        ...
        public com.mileston.walk.designwalk.MaterialViewPagerSettings settings;
