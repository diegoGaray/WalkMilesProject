...
import waves.token.walkmiles.MaterialViewPagerHeader;
import waves.token.walkmiles.MaterialViewPagerSettings;
import waves.token.walkmiles.Utils;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

import static waves.token.walkmiles.Utils.canScroll;
import static waves.token.walkmiles.Utils.colorWithAlpha;
import static waves.token.walkmiles.Utils.dpToPx;
import static waves.token.walkmiles.Utils.getTheVisibileView;
import static waves.token.walkmiles.Utils.minMax;
import static waves.token.walkmiles.Utils.scrollTo;
import static waves.token.walkmiles.Utils.setBackgroundColor;
import static waves.token.walkmiles.Utils.setElevation;
import static waves.token.walkmiles.Utils.setScale;
